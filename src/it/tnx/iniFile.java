    ...
    public void saveFile() {
        try {
            ...
            for (int i=0;i<lines.size();i++) {
                ...
                //debug
                if (lines.elementAt(i).toString().indexOf("pass") < 0 && lines.elementAt(i).toString().indexOf("pwd") < 0) {
...
//***************************************************************************+
    public static String simpleCrypt(String toCrypt, boolean flagCrypt) {
        ...
        char[] passwd = {'b','e','r','l','u','s','o','n','i','c','a','p','o','d','e','l','l','a','m','a','f','i','a','2','0','0','2'};
        //char[] passwd = {'a'};
        char[] out = crypt;
        int ip = 0;
        for (int i = 0 ; i < toCrypt.length() ; i++) {
            if (i % passwd.length == 0) ip = 0;
            if (flagCrypt == true) {
