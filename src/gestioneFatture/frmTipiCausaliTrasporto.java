...
public class frmTipiCausaliTrasporto
    extends javax.swing.JInternalFrame {

    tnxbeans.tnxComboField comboToRefresh;

    /** Creates new form frmDati_blank */
    public frmTipiCausaliTrasporto() {
        initComponents();

        //associo il panel ai dati
        this.dati.dbNomeTabella = "tipi_causali_trasporto";
        ...
        this.dati.dbOpen(Db.getConn(), "select * from tipi_causali_trasporto order by nome");
        this.dati.dbRefresh();
        ...
        this.griglia.dbOpen(Db.getConn(), "select id, nome from tipi_causali_trasporto order by nome");
    ...
    private void butStampaElencoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_butStampaElencoActionPerformed
        ...
        String nomeFilePdf = this.griglia.stampaTabella("Elenco Causali di Trasporto", headerWidth);
    ...
    private void butNewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_butNewActionPerformed
        ...
        try {
            ...
            String sql = "select id from tipi_causali_trasporto order by id desc limit 1";
