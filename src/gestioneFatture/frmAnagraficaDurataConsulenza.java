 ...
 * @author Alessio
 */
public class frmAnagraficaDurataConsulenza extends javax.swing.JInternalFrame {

    /** Creates new form frmAnagraficaEmissioneFattura */
    public frmAnagraficaDurataConsulenza() {
        initComponents();

        //associo il panel ai dati
        this.dati.dbNomeTabella = "tipi_durata_consulenza";
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Anagrafica Durata Consulenza");
        ...
        layout.setVerticalGroup(
            ...
            .add(layout.createSequentialGroup()
                ...
                .add(tabCent, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 124, Short.MAX_VALUE)
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmAnagraficaDurataConsulenza().setVisible(true);
            }
        });
    }
