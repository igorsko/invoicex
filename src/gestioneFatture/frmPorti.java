...
public class frmPorti
    ...
    public frmPorti() {
        ...
        this.dati.dbNomeTabella = "tipi_porto";
        ...
        this.dati.dbOpen(Db.getConn(), "select * from tipi_porto order by porto");
        this.dati.dbRefresh();
        ...
        colsWidthPerc.put("porto", new Double(35));
        this.griglia.columnsSizePerc = colsWidthPerc;
        this.griglia.dbOpen(Db.getConn(), "select id, porto from tipi_porto order by porto");
    ...
    private void initComponents() {
        ...
        texRagiSoci.setText("porto");
        texRagiSoci.setDbNomeCampo("porto");
    ...
    private void butStampaElencoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_butStampaElencoActionPerformed
        ...
        String nomeFilePdf = this.griglia.stampaTabella("Elenco Tipi Porto", headerWidth);
    ...
    private void butNewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_butNewActionPerformed
        ...
        try {
            ...
            String sql = "select id from tipi_porto order by id desc limit 1";
