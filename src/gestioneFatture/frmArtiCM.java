...
public class frmArtiCM
        ...
        dati.addDbListener(new DbListener() {
            ...
            public void statusFired(DbEvent event) {
                if (event.getStatus() == dati.STATUS_REFRESHING || event.getStatus() == dati.STATUS_ADDING) {
                    if (frmArtiCM.this.texTipo.getText().equals("A")) {
                        frmArtiCM.this.grpSel.setSelected(frmArtiCM.this.rbtAcq.getModel(), true);
                    } else if (frmArtiCM.this.texTipo.getText().equals("V")) {
                        frmArtiCM.this.grpSel.setSelected(frmArtiCM.this.rbtVen.getModel(), true);
                    } else {
                        frmArtiCM.this.grpSel.setSelected(frmArtiCM.this.rbtEnt.getModel(), true);
                    }
                }
            }
        });
    ...
    private void initComponents() {
        ...
        texUm.setmaxChars(3);
        dati.add(texUm, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 110, 30, -1));
        ...
        dati.add(texPrez, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 140, 90, -1));

        jLabel2.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel2.setText("unità di misura");
        dati.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 110, 105, 20));
        ...
        labPrez1.setText("prezzo listino 1");
        dati.add(labPrez1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 140, 100, 20));

        jLabel231.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel231.setText("iva");
        dati.add(jLabel231, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 110, 100, 20));

        labPrez2.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        labPrez2.setText("prezzo listino 2");
        dati.add(labPrez2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 170, 100, 20));
        ...
        dati.add(texPrez1, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 170, 90, -1));
        ...
        dati.add(cheFlagConfezione2, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 140, -1, -1));

        cheFlagConfezione.setText("Gestione matricola");
        cheFlagConfezione.setDbDescCampo("");
        cheFlagConfezione.setDbNomeCampo("gestione_matricola");
        cheFlagConfezione.setDbTipoCampo("");
        dati.add(cheFlagConfezione, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 170, -1, -1));

        texDescrizione.setDbNomeCampo("descrizione");
        dati.add(texDescrizione, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 40, 365, 60));
        ...
        dati.add(rbtEnt, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 210, -1, -1));
        ...
        dati.add(rbtVen, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 210, -1, -1));
        ...
        dati.add(rbtAcq, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 210, -1, -1));

        jLabel8.setText("Tipologia Di Oggetto:");
        dati.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 190, -1, 20));

        texTipo.setBackground(new java.awt.Color(255, 51, 51));
        texTipo.setText("tipo");
        texTipo.setDbNomeCampo("tipo");
        dati.add(texTipo, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 210, 75, -1));
        ...
        dati.add(iva, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 110, 220, -1));
