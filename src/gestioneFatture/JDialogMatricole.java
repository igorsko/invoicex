...
public class JDialogMatricole extends javax.swing.JDialog {
    ...
    public JDialogMatricole(java.awt.Frame parent, boolean modal, int righe, int riga, String articolo, String serie, String numero, String anno, String nomeTabMatricole) {
        super(parent, modal);
        this.riga = riga;
        ...
        try {
            ...
            sql = "select * from " + nomeTabMatricole + " where numero = '" + numero + "'";
            sql += " and anno = '" + anno + "'";
            sql += " and riga = '" + riga + "'";
        ...
        layout.setHorizontalGroup(
            ...
            .add(layout.createSequentialGroup()
                ...
                .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    ...
                    .add(org.jdesktop.layout.GroupLayout.TRAILING, jLabel1, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 204, Short.MAX_VALUE))
                .addContainerGap())
        );
