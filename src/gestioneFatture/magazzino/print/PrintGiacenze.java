...
public class PrintGiacenze {
    ...
    public PrintGiacenze(java.sql.ResultSet resu, String titolo) {
        ...
        String ret = stampaTabella(titolo, null);
        Util.start(ret);
    }
...
//            datatable.setCellpadding(0);
            ...
            for (int i = 1; i <= meta.getColumnCount(); i++) {
                ...
                if (i == 1) {
                    tempPdfCell = new Cell(new Phrase("Articolo", bf));
                } else if (i == 2) {
                    tempPdfCell = new Cell(new Phrase("", bf));
                } else if (i == 3) {
                    tempPdfCell = new Cell(new Phrase("Giacenza", bf));
                }
