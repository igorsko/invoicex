...
public class frmTipiAspettoEsterioreBeni
    extends javax.swing.JInternalFrame {

    tnxbeans.tnxComboField comboToRefresh;

    /** Creates new form frmDati_blank */
    public frmTipiAspettoEsterioreBeni() {
        initComponents();

        //associo il panel ai dati
        this.dati.dbNomeTabella = "tipi_aspetto_esteriore_beni";
        ...
        this.dati.dbOpen(Db.getConn(), "select * from tipi_aspetto_esteriore_beni order by nome");
        this.dati.dbRefresh();
        ...
        this.griglia.dbOpen(Db.getConn(), "select id, nome from tipi_aspetto_esteriore_beni order by nome");
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Aspetto esteriore dei beni");
        ...
        datiLayout.linkSize(new java.awt.Component[] {jLabel2111, jLabel2211}, org.jdesktop.layout.GroupLayout.HORIZONTAL);
    ...
    private void butStampaElencoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_butStampaElencoActionPerformed
        ...
        String nomeFilePdf = this.griglia.stampaTabella("Elenco Aspetto esteriore beni", headerWidth);
    ...
    private void butNewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_butNewActionPerformed
        ...
        try {
            ...
            String sql = "select id from tipi_aspetto_esteriore_beni order by id desc limit 1";
