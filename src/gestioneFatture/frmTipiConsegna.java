...
public class frmTipiConsegna
    ...
    public frmTipiConsegna() {
        ...
        this.dati.dbOpen(Db.getConn(), "select * from tipi_consegna order by nome");
        this.dati.dbRefresh();
        ...
        this.griglia.dbOpen(Db.getConn(), "select id, nome from tipi_consegna order by nome");
    ...
    private void butStampaElencoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_butStampaElencoActionPerformed
        ...
        String nomeFilePdf = this.griglia.stampaTabella("Elenco modalità di consegna", headerWidth);
