 ...
 * @author Alessio
 */
public class frmAnagraficaDurataContratto extends javax.swing.JInternalFrame {

    /** Creates new form frmAnagraficaEmissioneFattura */
    public frmAnagraficaDurataContratto() {
        initComponents();

        //associo il panel ai dati
        this.dati.dbNomeTabella = "tipi_durata_contratto";
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Anagrafica Durata Contratto");
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmAnagraficaDurataContratto().setVisible(true);
            }
        });
    }
